...
import { CampEncounterCombatTraining } from './CampEncounterCombatTraining'
  ...
  return {
    ...
    setup: (ctx, props) => {
      ...
      if (props.encounterVisitCount === 1) {
        ctx.log(
          <Narration>
            Your party finds their way to a friendly village on the outskirts of
            the forest. As you look around you see a small Inn and a group of
            soldiers training in the courtyard.
          </Narration>
        )
      } else {
        ctx.log(
