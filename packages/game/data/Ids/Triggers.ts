...
export const DamageSourceOnSelfTakeDamageId = TriggerId()
export const DrainLifeParentOnTurnEndId = TriggerId()
...
export const BleedDamageOnTurnEndId = TriggerId()
export const LightningAuraOnTakeDamageId = TriggerId()
